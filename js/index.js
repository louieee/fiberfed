(($)=>{
    $(document).ready(()=>{
        ...
        $('.bck-scnd-pg-2').on('click', ()=>gotoPage(1))
        ...
        function togglePageElements(page=1){
            if(page === 1){
                ...
                if(addressPayload.addresses.length > 0){
                    const tmp_list =  addressPayload.addresses.map((address, index)=>`#${index+1}. ${address.address}`);
                                        ...
                                        <div class="card-body px-0">
                                            ...
                                            <div class="row justify-content-center align-content-center">
                                                <a id="pricing_${i}" href="javascript:void(0)" class="text-muted pt-2 font-weight-bolder" data-toggle="modal" data-target="#quoteRequest">
                                                    <img src="./images/icons/envelop.svg" alt="line">&nbsp; ${pricing_list[i].min_cost==='ICB'?'REQUEST QUOTE': 'GET QUOTE'}
                                                </a>
                                            </div>
                                        </div>
                                    </div>
